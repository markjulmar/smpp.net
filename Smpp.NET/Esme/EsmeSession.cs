...
namespace JulMar.Smpp.Esme
{
    ...
    public class EsmeSession : SmppSession
    {
        ...
        /// <summary>
        /// This method retrieves the result of an asynchronous EnquireLink method call
        /// </summary>
        /// <param name="iar">Result from BeginEnquireLink</param>
        /// <returns>enquire_link_resp packet</returns>
        public enquire_link_resp EndEnquireLink(IAsyncResult iar)
        {
            return (enquire_link_resp)AsynchCall.ProcessEndInvoke(iar);
        }
    }
}
