...
namespace JulMar.Smpp.Pdu {
	/// <summary>
	/// The bind_transmitter PDU is used to bind a transmission side connection from an ESME to a MC.
	/// </summary>
	public class bind_transmitter : SmppRequest {
		// Class data
		...
		/// <summary>
		/// Password for the transmitter; may be blank.
		/// </summary>
		...
		public override string ToString() {
			return string.Format("bind_transmitter: {0},sid={1},pwd={2},type={3},ver={4},{5}{6}",
