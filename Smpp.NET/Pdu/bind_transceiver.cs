...
namespace JulMar.Smpp.Pdu {
	/// <summary>
	/// The bind_transceiver PDU is used to bind a transmit/receive connection from an ESME to a MC.
	/// </summary>
	public class bind_transceiver : SmppRequest {
		// Class data
		...
		/// <summary>
		/// Password for the transceiver; may be blank.
		/// </summary>
		...
		public override string ToString() {
			return string.Format("bind_transceiver: {0},sid={1},pwd={2},type={3},ver={4},{5}{6}",
